                                        ...
                                        <div className="col-lg-12 col-md-6 m-b30" >
                                            <div className="icon-bx-wraper bx-style-1 p-a20 radius-sm">
                                                <div className="icon-content">
                                                    ...
                                                    <p>Delhi Palam Near Jaat Dharamsala India </p>
                                        ...
                                        <div className="col-lg-12 col-md-6 m-b30 ">
                                            <div className="icon-bx-wraper bx-style-1 p-a20 radius-sm">
                                                <div className="icon-content">
                                                    ...
                                                    <p className="m-b0">info@praveen.com</p>
                                                    <p className="m-b0">sales@praveen.com</p>
                                                    <p className="m-b0">hr@praveen.com</p>
                                                    <p>support@praveen.com</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-lg-12 col-md-6 m-b30 ">
