            ...
            <>
                <footer className="site-footer text-uppercase">
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-4 col-md-6 col-sm-6 footer-col-4">
                                    <div className="widget widget_getintuch">
                                        ...
                                        <ul>
                                            <li><i className="ti-location-pin"></i><strong>address</strong> Delhi Palam Near Jaat Dharamsala India </li>
                                            <li><i className="ti-mobile"></i><strong>phone</strong>9102603030 (24/7 Support Line)</li>
                                            <li><i className="ti-email"></i><strong>email</strong>praveen@gmail.com</li>
                                        </ul>
                                    </div>
                                </div>
                                <div className="col-lg-4 col-md-6 col-sm-6 footer-col-4 ">
                    ...
                    <div className="footer-bottom bg-primary">
                        <div className="container">
                            <div className="row">
                                <div className="col-lg-6 col-md-6 col-sm-6 text-left "> <span>Copyright © 2021 Praveen</span> </div>
