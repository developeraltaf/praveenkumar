                        ...
                        <div className="container">
                            <div className="row d-flex justify-content-between">
                                <div className="dlab-topbar-left">
                                    <ul>
                                        <li><i className="flaticon-phone-call m-r5"></i> 9102603030</li>
                                        <li><i className="ti-location-pin m-r5"></i> Delhi Palam Near Jaat Dharamsala India</li>
                                    </ul>
                                </div>
                                <div className="dlab-topbar-right">
                                    <ul>
                                        <li><i className="ti-skype m-r5"></i> Praveen.software</li>
                                        <li><i className="ti-email m-r5"></i> Praveen@gmail.com</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
